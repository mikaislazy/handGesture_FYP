...
def get_normalized__keypoints_dataset(input_json, output_json):
    ...
    for gesture_name, keypoints in data.items():
        ...
        normalized_data[gesture_name] = {
            'left_hand_pts': utils.normalize_keypoints(keypoints['left_hand_pts']) if 'left_hand_pts' in keypoints else [],
            'right_hand_pts': utils.normalize_keypoints(keypoints['right_hand_pts']) if 'right_hand_pts' in keypoints else [],
